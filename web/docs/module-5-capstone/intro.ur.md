...
1. **[Capstone Planning Guide](./planning-guide.md) کا جائزہ لیں**
2. **[Starter Repository](https://github.com/physical-ai-textbook/capstone-template) کو fork کریں**
3. **Discord #capstone-projects channel میں شامل ہوں**
4. **1:1 planning session schedule کریں (اختیاری)**
