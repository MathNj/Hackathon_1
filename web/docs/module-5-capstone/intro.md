...
1. **Review the [Capstone Planning Guide](./planning-guide.md)**
2. **Fork the [Starter Repository](https://github.com/physical-ai-textbook/capstone-template)**
3. **Join the Discord #capstone-projects channel**
4. **Schedule a 1:1 planning session (optional)**
