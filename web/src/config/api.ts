...
export const AUTH_API_URL = isProduction
  ? 'https://textbook-auth-kfugkdqi5-mathnjs-projects.vercel.app/api'
  : 'http://localhost:3001/api';

// API Server (Vercel Serverless)
export const API_BASE_URL = isProduction
  ? 'https://textbook-edpneit7q-mathnjs-projects.vercel.app'
  : 'http://localhost:8000';

// Auth Client Base URL (for Better Auth)
export const AUTH_BASE_URL = isProduction
  ? 'https://textbook-auth-kfugkdqi5-mathnjs-projects.vercel.app'
  : 'http://localhost:3001';
